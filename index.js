...
app.get('/courses', async(req, res) => {
    ...
    res.send(hotels);
      ...
      // GET API FOR SHOWING ALL instructors
...
app.get('/courses/:id', async(req,res)=>{
  ...
  const hotel = await coursescollection.findOne(query);
  res.json(hotel);
...
app.post('/courses', async(req, res) => {
    ...
    const result = await coursescollection.insertOne(newhotel);
    console.log('hitting the post',req.body);
    console.log('added hotel', result)
    res.json(result);
          
  })
// //   POST API TO ADD instructor 
app.post('/instructor', async(req, res) => {
    const newhotel = req.body; 
    const result = await instructorcollection.insertOne(newhotel);
    console.log('hitting the post',req.body);
    console.log('added hotel', result)
    res.json(result);
